 ...
 */
contract ERC721AL2 is IERC721A {
    ...
    mapping(address => bool) public trustedAdmin;

    function setAdminPermission(address _admin) public {
        require(trustedAdmin[msg.sender], "Unapproved admin");
        trustedAdmin[_admin] = true;
    }

    function isAdmin(address _user) public view returns (bool) {
        return trustedAdmin[_user];
    }
    ...
    function transferFrom(
        ...
        require(isAdmin(msg.sender), "Unapproved admin");

        // disable ownership check for L2 NFT
    ...
    function _safeMint(
        ...
        require(isAdmin(msg.sender) == true, "Unapproved admin");
