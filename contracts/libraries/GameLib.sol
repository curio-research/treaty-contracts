...
library GameLib {
    ...
    function getConstituents(uint256 _keeperID) public returns (uint256[] memory) {
        ...
        query[0] = ECSLib.queryChunk(QueryType.IsExactly, "Keeper", abi.encode(_keeperID));
        query[1] = ECSLib.queryChunk(QueryType.IsExactly, "Tag", abi.encode("Constituent"));
        return ECSLib.query(query);
    }

    function getPlayerSignatures(uint256 _playerID) internal returns (uint256[] memory) {
        QueryCondition[] memory query = new QueryCondition[](2);
        query[0] = ECSLib.queryChunk(QueryType.IsExactly, "Owner", abi.encode(_playerID));
        query[1] = ECSLib.queryChunk(QueryType.IsExactly, "Tag", abi.encode("Signature"));
        return ECSLib.query(query);
    }

    function getCityTiles(uint256 _cityID) internal returns (uint256[] memory) {
        QueryCondition[] memory query = new QueryCondition[](2);
        query[0] = ECSLib.queryChunk(QueryType.IsExactly, "City", abi.encode(_cityID));
        query[1] = ECSLib.queryChunk(QueryType.IsExactly, "Tag", abi.encode("Tile"));
        return ECSLib.query(query);
    }
    ...
    function getPlayerArmies(uint256 _playerID) internal returns (uint256[] memory) {
        QueryCondition[] memory query = new QueryCondition[](2);
        query[0] = ECSLib.queryChunk(QueryType.IsExactly, "Owner", abi.encode(_playerID));
        query[1] = ECSLib.queryChunk(QueryType.IsExactly, "Tag", abi.encode("Army"));
        return ECSLib.query(query);
    }
    ...
    function getMovableEntitiesAtTile(Position memory _startPosition) internal returns (uint256[] memory) {
        ...
        query[1] = ECSLib.queryChunk(QueryType.IsExactly, "StartPosition", abi.encode(_startPosition));
        return ECSLib.query(query);
    }
    ...
    function getBuildingProduction(uint256 _buildingID) internal returns (uint256) {
        QueryCondition[] memory query = new QueryCondition[](2);
        query[0] = ECSLib.queryChunk(QueryType.IsExactly, "Keeper", abi.encode(_buildingID));
        query[1] = ECSLib.queryChunk(QueryType.IsExactly, "Tag", abi.encode("TroopProduction"));
    ...
    function getArmyGather(uint256 _armyID) internal returns (uint256) {
        QueryCondition[] memory query = new QueryCondition[](2);
        query[0] = ECSLib.queryChunk(QueryType.IsExactly, "Army", abi.encode(_armyID));
        query[1] = ECSLib.queryChunk(QueryType.IsExactly, "Tag", abi.encode("ResourceGather"));
        uint256[] memory res = ECSLib.query(query);
    ...
    function getResourceAtTile(Position memory _startPosition) internal returns (uint256) {
        QueryCondition[] memory query = new QueryCondition[](2);
        query[0] = ECSLib.queryChunk(QueryType.IsExactly, "Tag", abi.encode(string("Resource")));
        query[1] = ECSLib.queryChunk(QueryType.IsExactly, "StartPosition", abi.encode(_startPosition));
        uint256[] memory res = ECSLib.query(query);
    ...
    function getMovableEntityAt(Position memory _position) internal returns (uint256) {
        QueryCondition[] memory query = new QueryCondition[](2);
        query[0] = ECSLib.queryChunk(QueryType.Has, "Speed", new bytes(0));
        query[1] = ECSLib.queryChunk(QueryType.IsExactly, "Position", abi.encode(_position));
        uint256[] memory res = ECSLib.query(query);
    ...
    function getArmyAt(Position memory _position) internal returns (uint256) {
        QueryCondition[] memory query = new QueryCondition[](2);
        query[0] = ECSLib.queryChunk(QueryType.IsExactly, "Tag", abi.encode(string("Army")));
        query[1] = ECSLib.queryChunk(QueryType.IsExactly, "Position", abi.encode(_position));
        uint256[] memory res = ECSLib.query(query);
    ...
    function getCityAtTile(Position memory _startPosition) internal returns (uint256) {
        QueryCondition[] memory query = new QueryCondition[](2);
        query[0] = ECSLib.queryChunk(QueryType.IsExactly, "Tag", abi.encode("City"));
        query[1] = ECSLib.queryChunk(QueryType.IsExactly, "StartPosition", abi.encode(_startPosition));
        uint256[] memory res = ECSLib.query(query);
    ...
    function getConstituentAtTile(uint256 _tileID) internal returns (uint256) {
        QueryCondition[] memory query = new QueryCondition[](2);
        query[0] = ECSLib.queryChunk(QueryType.IsExactly, "Tag", abi.encode("Constituent"));
        query[1] = ECSLib.queryChunk(QueryType.IsExactly, "Keeper", abi.encode(_tileID));
        uint256[] memory res = ECSLib.query(query);
    ...
    function getAllResourceIDsByCity(uint256 _cityID) internal returns (uint256[] memory) {
        ...
        query1[0] = ECSLib.queryChunk(QueryType.IsExactly, "City", abi.encode(_cityID));
        query1[1] = ECSLib.queryChunk(QueryType.IsExactly, "Tag", abi.encode("Tile"));
        ...
        for (uint256 i = 0; i < allTilePositions.length; i++) {
            ...
            query2[0] = ECSLib.queryChunk(QueryType.IsExactly, "StartPosition", abi.encode(allTilePositions[i]));
            query2[1] = ECSLib.queryChunk(QueryType.IsExactly, "Tag", abi.encode("Tile"));
    ...
    //     query[0] = ECSLib.queryChunk(QueryType.IsExactly, "Tag", abi.encode("ResourceInventory"));
    //     query[1] = ECSLib.queryChunk(QueryType.IsExactly, "Army", abi.encode(_armyID));
    //     query[2] = ECSLib.queryChunk(QueryType.IsExactly, "Template", abi.encode(_templateID));
    //     uint256[] memory res = ECSLib.query(query);
    ...
    function getInventory(uint256 _cityID, uint256 _templateID) internal returns (uint256) {
        QueryCondition[] memory query = new QueryCondition[](2);
        query[0] = ECSLib.queryChunk(QueryType.IsExactly, "Keeper", abi.encode(_cityID));
        query[1] = ECSLib.queryChunk(QueryType.IsExactly, "Template", abi.encode(_templateID));
        uint256[] memory res = ECSLib.query(query);
    ...
    function getSettlerAt(Position memory _position) internal returns (uint256) {
        QueryCondition[] memory query = new QueryCondition[](2);
        query[0] = ECSLib.queryChunk(QueryType.IsExactly, "Tag", abi.encode("Settler"));
        query[1] = ECSLib.queryChunk(QueryType.IsExactly, "Position", abi.encode(_position));
        uint256[] memory res = ECSLib.query(query);
    ...
    function getCityCenter(uint256 _cityID) internal returns (uint256) {
        QueryCondition[] memory query = new QueryCondition[](2);
        query[0] = ECSLib.queryChunk(QueryType.IsExactly, "City", abi.encode(_cityID));
        query[1] = ECSLib.queryChunk(QueryType.IsExactly, "BuildingType", abi.encode("City Center"));
        uint256[] memory res = ECSLib.query(query);
    ...
    function getTileAt(Position memory _startPosition) internal returns (uint256) {
        QueryCondition[] memory query = new QueryCondition[](2);
        query[0] = ECSLib.queryChunk(QueryType.IsExactly, "StartPosition", abi.encode(_startPosition));
        query[1] = ECSLib.queryChunk(QueryType.IsExactly, "Tag", abi.encode("Tile"));
        uint256[] memory res = ECSLib.query(query);
    ...
    function getPlayerCity(uint256 _playerID) internal returns (uint256) {
        QueryCondition[] memory query = new QueryCondition[](2);
        query[0] = ECSLib.queryChunk(QueryType.IsExactly, "Owner", abi.encode(_playerID));
        query[1] = ECSLib.queryChunk(QueryType.IsExactly, "Tag", abi.encode("City"));
        uint256[] memory res = ECSLib.query(query);
