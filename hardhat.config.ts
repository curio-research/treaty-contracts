...
const { USER1_PK, USER2_PK, LOCALHOST_USER1_PK, LOCALHOST_USER2_PK, CONSTELLATION_RPC_URL, TAILSCALE_MAIN, ALTLAYER_RPC_URL, CONSTELLATIONNEW_RPC_URL, EXFAC_RPC_URL } = process.env;
