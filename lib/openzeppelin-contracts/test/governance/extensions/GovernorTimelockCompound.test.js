...
contract('GovernorTimelockCompound', function (accounts) {
  ...
  it('nominal', async function () {
    ...
    await expectEvent.inTransaction(txExecute.tx, this.timelock, 'executeGameTx', { eta });
  ...
  describe('should revert', function () {
    ...
    describe('on execute', function () {
      ...
      it('if too early', async function () {
        ...
        await expectRevert(this.helper.execute(), "Timelock::executeGameTx: Transaction hasn't surpassed time lock");
      });
