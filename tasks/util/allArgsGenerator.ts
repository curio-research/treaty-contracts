...
import { generateGameConstants, WORLD_WIDTH, WORLD_HEIGHT, ROOM_LENGTH, MAP_MODE } from './constants';
...
export const generateAllGameArgs = (allGameItems: ItemWithMetadata[], itemRatio: number[]): AllGameArgs => {
  ...
  const masterGameSpecs = generateMap(WORLD_WIDTH, WORLD_HEIGHT, ROOM_LENGTH, 5, MAP_MODE.DEFAULT);
