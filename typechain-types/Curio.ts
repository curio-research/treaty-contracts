...
export interface CurioInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'combineArmy', values: [BigNumberish, BigNumberish[]]): string;
  encodeFunctionData(functionFragment: 'deleteTroop', values: [BigNumberish]): string;
  encodeFunctionData(functionFragment: 'detachTroopsFromArmy', values: [BigNumberish, BigNumberish[], PositionStruct]): string;
  ...
  decodeFunctionResult(functionFragment: 'combineArmy', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'deleteTroop', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'detachTroopsFromArmy', data: BytesLike): Result;
...
export interface Curio extends BaseContract {
  ...
  functions: {
    ...
    combineArmy(_mainArmyId: BigNumberish, _joiningArmyIds: BigNumberish[], overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    deleteTroop(_troopId: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    detachTroopsFromArmy(_mainArmyId: BigNumberish, _leavingTroopIds: BigNumberish[], _targetPos: PositionStruct, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    combineArmy(_mainArmyId: BigNumberish, _joiningArmyIds: BigNumberish[], overrides?: CallOverrides): Promise<void>;

    deleteTroop(_troopId: BigNumberish, overrides?: CallOverrides): Promise<void>;

    detachTroopsFromArmy(_mainArmyId: BigNumberish, _leavingTroopIds: BigNumberish[], _targetPos: PositionStruct, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    combineArmy(_mainArmyId: BigNumberish, _joiningArmyIds: BigNumberish[], overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    deleteTroop(_troopId: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    detachTroopsFromArmy(_mainArmyId: BigNumberish, _leavingTroopIds: BigNumberish[], _targetPos: PositionStruct, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    combineArmy(_mainArmyId: BigNumberish, _joiningArmyIds: BigNumberish[], overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    deleteTroop(_troopId: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    detachTroopsFromArmy(_mainArmyId: BigNumberish, _leavingTroopIds: BigNumberish[], _targetPos: PositionStruct, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;
