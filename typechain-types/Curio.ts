...
export type WorldConstantsStructOutput = [string, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber] & {
  admin: string;
...
export interface CurioInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'getComponent', values: [string]): string;
  encodeFunctionData(functionFragment: 'getComponentById', values: [BigNumberish]): string;
  ...
  encodeFunctionData(functionFragment: 'reactivatePlayer', values: [string]): string;
  encodeFunctionData(functionFragment: 'registerComponents', values: [string, ComponentSpecStruct[]]): string;
  encodeFunctionData(functionFragment: 'registerDefaultComponents', values: [string]): string;
  encodeFunctionData(functionFragment: 'resumeGame', values?: undefined): string;
  encodeFunctionData(functionFragment: 'setComponentValue', values: [string, BigNumberish, BytesLike]): string;
  encodeFunctionData(functionFragment: 'spawnTroop', values: [PositionStruct, string, BigNumberish]): string;
  encodeFunctionData(functionFragment: 'storeEncodedColumnBatches', values: [BigNumberish[][]]): string;
  encodeFunctionData(functionFragment: 'transferBaseOwnership', values: [PositionStruct, string]): string;
  encodeFunctionData(functionFragment: 'updatePlayerBalances', values: [string]): string;
  encodeFunctionData(functionFragment: 'owner', values?: undefined): string;
  encodeFunctionData(functionFragment: 'transferOwnership', values: [string]): string;
  encodeFunctionData(functionFragment: 'sampleBuffPolicy', values?: undefined): string;
  encodeFunctionData(functionFragment: 'sampleImpossiblePolicy', values?: undefined): string;
  encodeFunctionData(functionFragment: 'workersOfTheWorldUnite', values?: undefined): string;
  encodeFunctionData(functionFragment: '_coincident', values: [PositionStruct, PositionStruct]): string;
  encodeFunctionData(functionFragment: '_concatenate', values: [BigNumberish[], BigNumberish[]]): string;
  encodeFunctionData(functionFragment: '_difference', values: [string, string]): string;
  encodeFunctionData(functionFragment: '_getAddress', values: [string, BigNumberish]): string;
  ...
  encodeFunctionData(functionFragment: '_getArmyTroopEntities', values: [BigNumberish]): string;
  encodeFunctionData(functionFragment: '_getBool', values: [string, BigNumberish]): string;
  encodeFunctionData(functionFragment: '_getComponent', values: [string]): string;
  encodeFunctionData(functionFragment: '_getComponentByEntity', values: [BigNumberish]): string;
  encodeFunctionData(functionFragment: '_getComponentValue', values: [string, BigNumberish]): string;
  encodeFunctionData(functionFragment: '_getDebuffedArmyDamagePerHit', values: [BigNumberish[]]): string;
  encodeFunctionData(functionFragment: '_getInfantryPercentage', values: [BigNumberish[]]): string;
  encodeFunctionData(functionFragment: '_getInt', values: [string, BigNumberish]): string;
  encodeFunctionData(functionFragment: '_getNeighbors', values: [PositionStruct]): string;
  encodeFunctionData(functionFragment: '_getPlayerEntity', values: [string]): string;
  encodeFunctionData(functionFragment: '_getPosition', values: [string, BigNumberish]): string;
  encodeFunctionData(functionFragment: '_getString', values: [string, BigNumberish]): string;
  encodeFunctionData(functionFragment: '_getTileAt', values: [PositionStruct]): string;
  encodeFunctionData(functionFragment: '_getUint', values: [string, BigNumberish]): string;
  ...
  encodeFunctionData(functionFragment: '_strEq', values: [string, string]): string;
  ...
  decodeFunctionResult(functionFragment: 'transferBaseOwnership', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'updatePlayerBalances', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'owner', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'transferOwnership', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'sampleBuffPolicy', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'sampleImpossiblePolicy', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'workersOfTheWorldUnite', data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: '_getArmyTroopEntities', data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: '_getDebuffedArmyDamagePerHit', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: '_getInfantryPercentage', data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: '_getPlayerEntity', data: BytesLike): Result;
...
export type DiamondCutEvent = TypedEvent<[FacetCutStructOutput[], string, string], { _diamondCut: FacetCutStructOutput[]; _init: string; _calldata: string }>;
...
export type ComponentValueSetEvent = TypedEvent<[string, BigNumber, string], { _componentName: string; _entity: BigNumber; _value: string }>;

export type ComponentValueSetEventFilter = TypedEventFilter<ComponentValueSetEvent>;

export type EntityRemovedEvent = TypedEvent<[BigNumber], { _entity: BigNumber }>;
...
export type NewComponentEvent = TypedEvent<[string, BigNumber], { _name: string; _entity: BigNumber }>;
...
export interface Curio extends BaseContract {
  ...
  functions: {
    diamondCut(_diamondCut: FacetCutStruct[], _init: string, _calldata: BytesLike, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    facetAddress(_functionSelector: BytesLike, overrides?: CallOverrides): Promise<[string] & { facetAddress_: string }>;

    facetAddresses(overrides?: CallOverrides): Promise<[string[]] & { facetAddresses_: string[] }>;

    facetFunctionSelectors(_facet: string, overrides?: CallOverrides): Promise<[string[]] & { _facetFunctionSelectors: string[] }>;
    ...
    getComponentById(_entity: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
    ...
    addEntity(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    bulkInitializeTiles(_positions: PositionStruct[], overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    pauseGame(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    reactivatePlayer(_player: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    registerComponents(_gameAddr: string, _componentSpecs: ComponentSpecStruct[], overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    registerDefaultComponents(_gameAddr: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    resumeGame(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    setComponentValue(_componentName: string, _entity: BigNumberish, _value: BytesLike, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    spawnTroop(_position: PositionStruct, _player: string, _troopTemplateEntity: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    storeEncodedColumnBatches(_colBatches: BigNumberish[][], overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    transferBaseOwnership(_position: PositionStruct, _player: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    updatePlayerBalances(_player: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    owner(overrides?: CallOverrides): Promise<[string] & { owner_: string }>;

    transferOwnership(_newOwner: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    sampleBuffPolicy(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    sampleImpossiblePolicy(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    workersOfTheWorldUnite(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    _coincident(_p1: PositionStruct, _p2: PositionStruct, overrides?: CallOverrides): Promise<[boolean]>;

    _concatenate(_arr1: BigNumberish[], _arr2: BigNumberish[], overrides?: CallOverrides): Promise<[BigNumber[]]>;

    _difference(set1: string, set2: string, overrides?: CallOverrides): Promise<[BigNumber[]]>;

    _getAddress(_componentName: string, _entity: BigNumberish, overrides?: CallOverrides): Promise<[string]>;

    _getArmyAttackFactor(_troopEntities: BigNumberish[], overrides?: CallOverrides): Promise<[BigNumber]>;

    _getArmyDamagePerHit(_troopEntities: BigNumberish[], overrides?: CallOverrides): Promise<[BigNumber]>;

    _getArmyDefenseFactor(_troopEntities: BigNumberish[], overrides?: CallOverrides): Promise<[BigNumber]>;

    _getArmyHealth(_troopEntities: BigNumberish[], overrides?: CallOverrides): Promise<[BigNumber]>;

    _getArmyLargeActionCooldown(_troopEntities: BigNumberish[], overrides?: CallOverrides): Promise<[BigNumber]>;

    _getArmyMovementCooldown(_troopEntities: BigNumberish[], overrides?: CallOverrides): Promise<[BigNumber]>;

    _getArmyTroopEntities(_armyEntity: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber[]]>;

    _getBool(_componentName: string, _entity: BigNumberish, overrides?: CallOverrides): Promise<[boolean]>;

    _getComponent(_name: string, overrides?: CallOverrides): Promise<[string]>;

    _getComponentByEntity(_entity: BigNumberish, overrides?: CallOverrides): Promise<[string]>;

    _getComponentValue(_componentName: string, _entity: BigNumberish, overrides?: CallOverrides): Promise<[string]>;

    _getDebuffedArmyDamagePerHit(_troopEntities: BigNumberish[], overrides?: CallOverrides): Promise<[BigNumber]>;

    _getInfantryPercentage(_troopEntities: BigNumberish[], overrides?: CallOverrides): Promise<[BigNumber]>;

    _getInt(_componentName: string, _entity: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;

    _getNeighbors(_position: PositionStruct, overrides?: CallOverrides): Promise<[PositionStructOutput[]]>;

    _getPlayerEntity(_player: string, overrides?: CallOverrides): Promise<[BigNumber]>;

    _getPosition(_componentName: string, _entity: BigNumberish, overrides?: CallOverrides): Promise<[PositionStructOutput]>;

    _getString(_componentName: string, _entity: BigNumberish, overrides?: CallOverrides): Promise<[string]>;

    _getTileAt(_position: PositionStruct, overrides?: CallOverrides): Promise<[TileStructOutput]>;

    _getUint(_componentName: string, _entity: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    _withinDistance(_p1: PositionStruct, _p2: PositionStruct, _dist: BigNumberish, overrides?: CallOverrides): Promise<[boolean]>;
  };
  ...
  callStatic: {
    ...
    registerComponents(_gameAddr: string, _componentSpecs: ComponentSpecStruct[], overrides?: CallOverrides): Promise<void>;

    registerDefaultComponents(_gameAddr: string, overrides?: CallOverrides): Promise<void>;

    resumeGame(overrides?: CallOverrides): Promise<void>;

    setComponentValue(_componentName: string, _entity: BigNumberish, _value: BytesLike, overrides?: CallOverrides): Promise<void>;

    spawnTroop(_position: PositionStruct, _player: string, _troopTemplateEntity: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;

    storeEncodedColumnBatches(_colBatches: BigNumberish[][], overrides?: CallOverrides): Promise<void>;

    transferBaseOwnership(_position: PositionStruct, _player: string, overrides?: CallOverrides): Promise<void>;

    updatePlayerBalances(_player: string, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    diamondCut(_diamondCut: FacetCutStruct[], _init: string, _calldata: BytesLike, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
    ...
    getComponentById(_entity: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    addEntity(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    bulkInitializeTiles(_positions: PositionStruct[], overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    pauseGame(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    reactivatePlayer(_player: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    registerComponents(_gameAddr: string, _componentSpecs: ComponentSpecStruct[], overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    registerDefaultComponents(_gameAddr: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    resumeGame(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    setComponentValue(_componentName: string, _entity: BigNumberish, _value: BytesLike, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    spawnTroop(_position: PositionStruct, _player: string, _troopTemplateEntity: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    storeEncodedColumnBatches(_colBatches: BigNumberish[][], overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    transferBaseOwnership(_position: PositionStruct, _player: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    updatePlayerBalances(_player: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    owner(overrides?: CallOverrides): Promise<BigNumber>;

    transferOwnership(_newOwner: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    sampleBuffPolicy(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    sampleImpossiblePolicy(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    workersOfTheWorldUnite(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
    ...
    _getAddress(_componentName: string, _entity: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    _getBool(_componentName: string, _entity: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;

    _getComponent(_name: string, overrides?: CallOverrides): Promise<BigNumber>;

    _getComponentByEntity(_entity: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;

    _getComponentValue(_componentName: string, _entity: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    _getPosition(_componentName: string, _entity: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;

    _getString(_componentName: string, _entity: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;

    _getTileAt(_position: PositionStruct, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    _strEq(_s1: string, _s2: string, overrides?: CallOverrides): Promise<BigNumber>;

    _strike(_strikeFactor: BigNumberish, _salt: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;

    _withinDistance(_p1: PositionStruct, _p2: PositionStruct, _dist: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
  };

  populateTransaction: {
    diamondCut(_diamondCut: FacetCutStruct[], _init: string, _calldata: BytesLike, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;
    ...
    getComponent(_name: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    getComponentById(_entity: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    addEntity(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    bulkInitializeTiles(_positions: PositionStruct[], overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    pauseGame(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    reactivatePlayer(_player: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    registerComponents(_gameAddr: string, _componentSpecs: ComponentSpecStruct[], overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    registerDefaultComponents(_gameAddr: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    resumeGame(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    setComponentValue(_componentName: string, _entity: BigNumberish, _value: BytesLike, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    spawnTroop(_position: PositionStruct, _player: string, _troopTemplateEntity: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    storeEncodedColumnBatches(_colBatches: BigNumberish[][], overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    transferBaseOwnership(_position: PositionStruct, _player: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    updatePlayerBalances(_player: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;
    ...
    sampleBuffPolicy(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    sampleImpossiblePolicy(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    workersOfTheWorldUnite(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    _coincident(_p1: PositionStruct, _p2: PositionStruct, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _concatenate(_arr1: BigNumberish[], _arr2: BigNumberish[], overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _difference(set1: string, set2: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _getAddress(_componentName: string, _entity: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _getArmyAttackFactor(_troopEntities: BigNumberish[], overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _getArmyDamagePerHit(_troopEntities: BigNumberish[], overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _getArmyDefenseFactor(_troopEntities: BigNumberish[], overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _getArmyHealth(_troopEntities: BigNumberish[], overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _getArmyLargeActionCooldown(_troopEntities: BigNumberish[], overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _getArmyMovementCooldown(_troopEntities: BigNumberish[], overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _getArmyTroopEntities(_armyEntity: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _getBool(_componentName: string, _entity: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _getComponent(_name: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _getComponentByEntity(_entity: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _getComponentValue(_componentName: string, _entity: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _getDebuffedArmyDamagePerHit(_troopEntities: BigNumberish[], overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _getInfantryPercentage(_troopEntities: BigNumberish[], overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _getInt(_componentName: string, _entity: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _getNeighbors(_position: PositionStruct, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _getPlayerEntity(_player: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _getPosition(_componentName: string, _entity: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _getString(_componentName: string, _entity: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _getTileAt(_position: PositionStruct, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _getUint(_componentName: string, _entity: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    _strEq(_s1: string, _s2: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _strike(_strikeFactor: BigNumberish, _salt: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _withinDistance(_p1: PositionStruct, _p2: PositionStruct, _dist: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
  };
}
