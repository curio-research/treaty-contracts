...
export type TroopStructOutput = [string, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber, PositionStructOutput, BigNumber[]] & {
  owner: string;
...
export type BaseStructOutput = [number, string, BigNumber, BigNumber, BigNumber] & {
  name: number;
  owner: string;
...
export type TroopTypeStructOutput = [number, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber, boolean] & {
  name: number;
...
export type WorldConstantsStructOutput = [string, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber] & {
  admin: string;
...
export interface CurioInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'battle', values: [BigNumberish, PositionStruct]): string;
  encodeFunctionData(functionFragment: 'captureBase', values: [BigNumberish, PositionStruct]): string;
  encodeFunctionData(functionFragment: 'endProduction', values: [PositionStruct]): string;
  encodeFunctionData(functionFragment: 'initializePlayer', values: [PositionStruct, string]): string;
  encodeFunctionData(functionFragment: 'move', values: [BigNumberish, PositionStruct]): string;
  encodeFunctionData(functionFragment: 'repair', values: [PositionStruct]): string;
  encodeFunctionData(functionFragment: 'setMapChunk', values: [PositionStruct, BigNumberish[][]]): string;
  encodeFunctionData(functionFragment: 'spawnTroop', values: [PositionStruct, string, BigNumberish]): string;
  encodeFunctionData(functionFragment: 'startProduction', values: [PositionStruct, BigNumberish]): string;
  ...
  encodeFunctionData(functionFragment: 'getMapChunk', values: [PositionStruct]): string;
  ...
  encodeFunctionData(functionFragment: 'getTroopAt', values: [PositionStruct]): string;
  ...
  decodeFunctionResult(functionFragment: 'captureBase', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'endProduction', data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: 'setMapChunk', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'spawnTroop', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'startProduction', data: BytesLike): Result;
...
export type DeathEvent = TypedEvent<[string, BigNumber], { _player: string; _troopId: BigNumber }>;

export type DeathEventFilter = TypedEventFilter<DeathEvent>;

export type EpochUpdateEvent = TypedEvent<[BigNumber, BigNumber], { _epoch: BigNumber; _time: BigNumber }>;

export type EpochUpdateEventFilter = TypedEventFilter<EpochUpdateEvent>;

export type MovedEvent = TypedEvent<[string, BigNumber, PositionStructOutput], { _player: string; _troopId: BigNumber; _pos: PositionStructOutput }>;
...
export type ProductionStartedEvent = TypedEvent<[string, BigNumber, ProductionStructOutput], { _player: string; _baseId: BigNumber; _production: ProductionStructOutput }>;

export type ProductionStartedEventFilter = TypedEventFilter<ProductionStartedEvent>;
...
export interface Curio extends BaseContract {
  ...
  functions: {
    ...
    battle(_troopId: BigNumberish, _targetPos: PositionStruct, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    captureBase(_troopId: BigNumberish, _targetPos: PositionStruct, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    endProduction(_pos: PositionStruct, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    move(_troopId: BigNumberish, _targetPos: PositionStruct, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    repair(_pos: PositionStruct, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    setMapChunk(_startPos: PositionStruct, _chunk: BigNumberish[][], overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    spawnTroop(_pos: PositionStruct, _player: string, _troopTypeId: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    startProduction(_pos: PositionStruct, _troopTypeId: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    transferBaseOwnership(_pos: PositionStruct, _player: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    updateEpoch(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
    ...
    getMapChunk(_startPos: PositionStruct, overrides?: CallOverrides): Promise<[TileStructOutput[], PositionStructOutput[]]>;
    ...
    getTroopAt(_pos: PositionStruct, overrides?: CallOverrides): Promise<[TroopStructOutput]>;
  ...
  initializePlayer(_pos: PositionStruct, _player: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    battle(_troopId: BigNumberish, _targetPos: PositionStruct, overrides?: CallOverrides): Promise<void>;

    captureBase(_troopId: BigNumberish, _targetPos: PositionStruct, overrides?: CallOverrides): Promise<void>;

    endProduction(_pos: PositionStruct, overrides?: CallOverrides): Promise<void>;

    move(_troopId: BigNumberish, _targetPos: PositionStruct, overrides?: CallOverrides): Promise<void>;

    repair(_pos: PositionStruct, overrides?: CallOverrides): Promise<void>;

    setMapChunk(_startPos: PositionStruct, _chunk: BigNumberish[][], overrides?: CallOverrides): Promise<void>;

    spawnTroop(_pos: PositionStruct, _player: string, _troopTypeId: BigNumberish, overrides?: CallOverrides): Promise<void>;

    startProduction(_pos: PositionStruct, _troopTypeId: BigNumberish, overrides?: CallOverrides): Promise<void>;

    transferBaseOwnership(_pos: PositionStruct, _player: string, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    'AttackedBase(address,uint256,tuple,uint256,tuple)'(_player?: null, _troopId?: null, _troopInfo?: null, _targetBaseId?: null, _targetBaseInfo?: null): AttackedBaseEventFilter;
    AttackedBase(_player?: null, _troopId?: null, _troopInfo?: null, _targetBaseId?: null, _targetBaseInfo?: null): AttackedBaseEventFilter;

    'AttackedTroop(address,uint256,tuple,uint256,tuple)'(_player?: null, _troopId?: null, _troopInfo?: null, _targetTroopId?: null, _targetTroopInfo?: null): AttackedTroopEventFilter;
    AttackedTroop(_player?: null, _troopId?: null, _troopInfo?: null, _targetTroopId?: null, _targetTroopInfo?: null): AttackedTroopEventFilter;
    ...
    'EpochUpdate(uint256,uint256)'(_epoch?: null, _time?: null): EpochUpdateEventFilter;
    EpochUpdate(_epoch?: null, _time?: null): EpochUpdateEventFilter;

    'Moved(address,uint256,tuple)'(_player?: null, _troopId?: null, _pos?: null): MovedEventFilter;
    ...
    'NewTroop(address,uint256,tuple,tuple)'(_player?: null, _troopId?: null, _troop?: null, _pos?: null): NewTroopEventFilter;
    NewTroop(_player?: null, _troopId?: null, _troop?: null, _pos?: null): NewTroopEventFilter;

    'ProductionStarted(address,uint256,tuple)'(_player?: null, _baseId?: null, _production?: null): ProductionStartedEventFilter;
    ProductionStarted(_player?: null, _baseId?: null, _production?: null): ProductionStartedEventFilter;
  ...
  estimateGas: {
    ...
    battle(_troopId: BigNumberish, _targetPos: PositionStruct, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    captureBase(_troopId: BigNumberish, _targetPos: PositionStruct, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    endProduction(_pos: PositionStruct, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    move(_troopId: BigNumberish, _targetPos: PositionStruct, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    repair(_pos: PositionStruct, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    setMapChunk(_startPos: PositionStruct, _chunk: BigNumberish[][], overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    spawnTroop(_pos: PositionStruct, _player: string, _troopTypeId: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    startProduction(_pos: PositionStruct, _troopTypeId: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    transferBaseOwnership(_pos: PositionStruct, _player: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    updateEpoch(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
    ...
    getMapChunk(_startPos: PositionStruct, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    getTroopAt(_pos: PositionStruct, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    battle(_troopId: BigNumberish, _targetPos: PositionStruct, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    captureBase(_troopId: BigNumberish, _targetPos: PositionStruct, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    endProduction(_pos: PositionStruct, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    move(_troopId: BigNumberish, _targetPos: PositionStruct, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    repair(_pos: PositionStruct, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    setMapChunk(_startPos: PositionStruct, _chunk: BigNumberish[][], overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    spawnTroop(_pos: PositionStruct, _player: string, _troopTypeId: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    startProduction(_pos: PositionStruct, _troopTypeId: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    transferBaseOwnership(_pos: PositionStruct, _player: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    updateEpoch(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;
    ...
    getMapChunk(_startPos: PositionStruct, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    getTroopAt(_pos: PositionStruct, overrides?: CallOverrides): Promise<PopulatedTransaction>;
