...
export interface DiamondInitInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'init', values: [WorldConstantsStruct, TroopTypeStruct[]]): string;
...
export interface DiamondInit extends BaseContract {
  ...
  functions: {
    init(_worldConstants: WorldConstantsStruct, _troopTypes: TroopTypeStruct[], overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
  };

  init(_worldConstants: WorldConstantsStruct, _troopTypes: TroopTypeStruct[], overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

  callStatic: {
    init(_worldConstants: WorldConstantsStruct, _troopTypes: TroopTypeStruct[], overrides?: CallOverrides): Promise<void>;
  };

  filters: {};

  estimateGas: {
    init(_worldConstants: WorldConstantsStruct, _troopTypes: TroopTypeStruct[], overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
  };

  populateTransaction: {
    init(_worldConstants: WorldConstantsStruct, _troopTypes: TroopTypeStruct[], overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;
  };
}
