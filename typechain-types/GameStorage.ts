...
export type TileStructOutput = [string, string, BigNumber] & {
  occupier: string;
  owner: string;
  blockId: BigNumber;
};
...
export interface GameStorageInterface extends utils.Interface {
  functions: {
    ...
    "_getBlock((uint256,uint256))": FunctionFragment;
    ...
    "_setItem(uint256,(bool,bool,uint256,uint256[],uint256[],uint8))": FunctionFragment;
    ...
    "_setTileData((uint256,uint256),(address,address,uint256))": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "_getBlock", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "_getCurrentEpoch",
    data: BytesLike
  ): Result;
