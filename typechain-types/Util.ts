...
export interface UtilInterface extends utils.Interface {
  functions: {
    "_canArmyMoveLand(uint256)": FunctionFragment;
    "_canTroopMoveLand(uint256)": FunctionFragment;
    "_canTroopMoveToTile(uint256,uint8)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "_canArmyMoveLand",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "_canTroopMoveToTile",
