...
export interface UtilInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: '_getAttackCooldown', values: [BigNumberish]): string;
  ...
  encodeFunctionData(functionFragment: '_getCargoCapacity', values: [BigNumberish]): string;
  ...
  encodeFunctionData(functionFragment: '_getEpochsToProduce', values: [BigNumberish]): string;
  ...
  encodeFunctionData(functionFragment: '_getMovesPerEpoch', values: [BigNumberish]): string;
  ...
  encodeFunctionData(functionFragment: '_hasTroopTransport', values: [TileStruct]): string;
  ...
  encodeFunctionData(functionFragment: '_random', values: [BigNumberish]): string;
  encodeFunctionData(functionFragment: '_samePos', values: [PositionStruct, PositionStruct]): string;
  encodeFunctionData(functionFragment: '_strike', values: [BigNumberish]): string;
  encodeFunctionData(functionFragment: '_withinDist', values: [PositionStruct, PositionStruct, BigNumberish]): string;

  decodeFunctionResult(functionFragment: '_getAttackCooldown', data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: '_getCargoCapacity', data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: '_getEpochsToProduce', data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: '_getMovesPerEpoch', data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: '_hasTroopTransport', data: BytesLike): Result;
...
export interface Util extends BaseContract {
  ...
  functions: {
    _getAttackCooldown(_troopTypeId: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    _getCargoCapacity(_troopId: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    _getEpochsToProduce(_troopTypeId: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    _getMovesPerEpoch(_troopTypeId: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    _hasTroopTransport(_tile: TileStruct, overrides?: CallOverrides): Promise<[boolean]>;
    ...
    _strike(_strikeFactor: BigNumberish, overrides?: CallOverrides): Promise<[boolean]>;
  ...
  estimateGas: {
    ...
    _hasTroopTransport(_tile: TileStruct, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    _strike(_strikeFactor: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;

    _withinDist(_p1: PositionStruct, _p2: PositionStruct, _dist: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
  };

  populateTransaction: {
    _getAttackCooldown(_troopTypeId: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    _getCargoCapacity(_troopId: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    _getEpochsToProduce(_troopTypeId: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    _getMovesPerEpoch(_troopTypeId: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    _hasTroopTransport(_tile: TileStruct, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    _random(_max: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _samePos(_p1: PositionStruct, _p2: PositionStruct, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _strike(_strikeFactor: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
