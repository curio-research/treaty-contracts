...
export interface IntComponentInterface extends utils.Interface {
  functions: {
    "getAllEntitiesAndValues()": FunctionFragment;
    "getBytesValue(uint256)": FunctionFragment;
    "getEntities()": FunctionFragment;
    "getEntitiesWithValue(bytes)": FunctionFragment;
    "getEntitiesWithValue(int256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getEntitiesWithValue(int256)",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
...
export interface IntComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IntComponentInterface;
