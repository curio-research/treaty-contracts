...
export interface GetterFacet extends BaseContract {
  ...
  functions: {
    getAddress(_entityID: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    getAddress(_entityID: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    getAddress(_entityID: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
