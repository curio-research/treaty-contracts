...
export interface GetterFacetInterface extends utils.Interface {
  ...
  getFunction(nameOrSignatureOrTopic: 'getCityAt' | 'getCityCenter' | 'getComponent' | 'getComponentById' | 'getEntitiesAddr' | 'getEntity' | 'getInventoryByCityAndType' | 'getPlayerCount' | 'getPlayerId' | 'getSettlerAt' | 'getTemplateByInventoryType' | 'getTemplateId' | 'getTileAt' | 'getWorldConstants' | 'isPlayerInitialized'): FunctionFragment;
