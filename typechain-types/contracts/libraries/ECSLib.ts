...
export interface ECSLibInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic: 'getComponent' | 'concatenate' | 'getAddress' | 'getAddressComponent' | 'getBool' | 'getBoolComponent' | 'getComponentByEntity' | 'getComponentValue' | 'getInt' | 'getIntComponent' | 'getPosition' | 'getPositionComponent' | 'getString' | 'getStringComponent' | 'getUint' | 'getUintArray' | 'getUintArrayComponent' | 'getUintComponent' | 'query' | 'queryChunk'
  ): FunctionFragment;
