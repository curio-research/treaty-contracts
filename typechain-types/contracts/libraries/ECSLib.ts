...
export interface ECSLibInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic: 'concatenate' | 'difference' | 'getAddress' | 'getAddressComponent' | 'getBool' | 'getBoolComponent' | 'getComponent' | 'getComponentByEntity' | 'getComponentValue' | 'getInt' | 'getIntComponent' | 'getPosition' | 'getPositionComponent' | 'getString' | 'getStringComponent' | 'getUint' | 'getUintArray' | 'getUintArrayComponent' | 'getUintComponent' | 'queryChunk'
  ): FunctionFragment;
