...
export interface SlingerERC20Interface extends utils.Interface {
  functions: {
  ...
  getFunction(nameOrSignatureOrTopic: 'DOMAIN_SEPARATOR' | 'allowance' | 'approve' | 'balanceOf' | 'decimals' | 'name' | 'nonces' | 'permit' | 'symbol' | 'totalSupply' | 'transfer' | 'transferFrom'): FunctionFragment;
...
export interface CurioERC20 extends BaseContract {
  ...
  interface: SlingerERC20Interface;
