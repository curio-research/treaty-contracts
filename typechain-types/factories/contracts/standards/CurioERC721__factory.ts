...
export class CurioERC721__factory {
  ...
  static createInterface(): CurioERC721Interface {
    return new utils.Interface(_abi) as CurioERC721Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): CurioERC721 {
    return new Contract(address, _abi, signerOrProvider) as CurioERC721;
  }
}
