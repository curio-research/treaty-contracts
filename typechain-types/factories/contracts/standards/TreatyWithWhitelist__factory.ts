...
import type {
  TreatyWithWhitelist,
  TreatyWithWhitelistInterface,
} from "../../../contracts/standards/TreatyWithWhitelist";
...
const _abi = [
  ...
  {
    inputs: [],
    name: "treatyRemoveFromWhitelist",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
...
export class TreatyWithWhitelist__factory {
  static readonly abi = _abi;
  static createInterface(): TreatyWithWhitelistInterface {
    return new utils.Interface(_abi) as TreatyWithWhitelistInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): TreatyWithWhitelist {
    return new Contract(address, _abi, signerOrProvider) as TreatyWithWhitelist;
  }
}
